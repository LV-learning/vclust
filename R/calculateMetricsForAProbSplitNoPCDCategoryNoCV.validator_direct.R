...
calculateMetricsForAProbSplitNoPCDCategoryNoCV.validator_direct <- function(validator,
                                                                            categoryVec,
  ...
  if(supervised_model == "glmnet"){
    metrics_ij <- genGlmnetMetricsOpt(y = cat_vec_train,
  ...
  if(supervised_model == "glmnet"){
    metrics_j <- genGlmnetMetricsNoCV(y = cat_vec_train,
                                      predictor_part = predictor_part,
                                      input_and_pp_and_var_df = input_and_pp_and_var_df[train_ind,],
                                      y_test = cat_vec_test,
