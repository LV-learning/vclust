calculateMetricsForAProbNoPCDCategory <- function(validator,
                                                  categoryVec,
                                                  K_fold,
                                                  repeated_folds_R,
                                                  ...
                                                  n,
                                                  pcd_dropping_pct) {
  UseMethod("calculateMetricsForAProbNoPCDCategory")
}

#' @importFrom  stats aggregate var
calculateMetricsForAProbNoPCDCategory.default <- function(validator,
                                                          categoryVec,
                                                          K_fold,
                                                          repeated_folds_R,
                                                          input_and_pp_and_var_df,
